...
def main_menu():
    ...
    while run:
        WIN.fill(constants.GRAY)
        title_label = title_font.render("Click the mouse or hit SPACE", 1, (255,255,255))
        WIN.blit(title_label, (constants.SCREEN_WIDTH/2 - title_label.get_width()/2, 350) )

        instructions_label = instructions_font.render("Instructions: Left and Right arrows to move. Up arrow to Rotate. Q to Quit", 1, (255,255,255))
        WIN.blit(instructions_label,((constants.SCREEN_WIDTH/2 - title_label.get_width()/2, 550)))
        pygame.display.update()
